...
function App() {
  ...
  const fullpageList = ["login", "forgot-password"];
  const location = useLocation();
  const isFullPage = fullpageList.some(path => location.pathname.includes(path));
  ...
  return (
    <div>
      {isFullPage ? (
        ...
        <div>
          <Navbar />
          <div className="flex h-[92vh] mt-[8vh] justify-center items-start mx-auto">
            <div className="md:block hidden h-full"><Sidebar /></div>
            <div className="w-full h-full rounded-lg p-4 overflow-y-auto  ">
              <Routes>
